...
static void _SetPixelIndex(GUI_DEVICE * pDevice, int x, int y, int PixelIndex) {
	// if(pDevice->LayerIndex>=0 && pDevice->LayerIndex<
	#if LOWERUSED
	COMAND=0x05;
	DATA=pDevice->LayerIndex;	
	#endif 
  #ifdef WIN32
...
/*********************************************************************
*
*       _DrawVLine, not optimized  _DrawHLine1
*/
