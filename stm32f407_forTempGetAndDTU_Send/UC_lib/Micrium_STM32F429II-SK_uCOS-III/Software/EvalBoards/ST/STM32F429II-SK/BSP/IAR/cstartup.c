...
__root  const  APP_INTVECT_ELEM  __vector_table[] @ ".intvec" = {
    ...
    BSP_IntHandlerTIM1_BRK_TIM9,                                /*  40, INTISR[ 24]  TIM1 Break  Int. & TIM9 Glb Int.     */
    BSP_IntHandlerTIM1_UP_TIM10,                                /*  41, INTISR[ 25]  TIM1 Update Int. & TIM10 Glb Int.    */
    ...
    BSP_IntHandlerUSART6,                                       /*  87, INTISR[ 71]  USART6 global Interrupt.             */
    ...
    BSP_IntHandlerUART7,                                        /*  98, INTISR[ 82]  UART7 Interrupt.                     */
    BSP_IntHandlerUART8,                                        /*  99, INTISR[ 83]  UART8 Interrupt.                     */
    BSP_IntHandlerSPI4,                                         /* 100, INTISR[ 84]  SPI4  Interrupt.                     */
    BSP_IntHandlerSPI5,                                         /* 101, INTISR[ 85]  SPI5  Interrupt.                     */
    BSP_IntHandlerSPI6,                                         /* 102, INTISR[ 86]  SPI6  Interrupt.                     */
    BSP_IntHandlerSAI1,                                         /* 103, INTISR[ 87]  SAI1  Interrupt.                     */
    BSP_IntHandlerLTDC,                                         /* 104, INTISR[ 88]  LTDC  Interrupt.                     */
    BSP_IntHandlerLTDC_ER,                                      /* 105, INTISR[ 89]  LTDC Error Interrupt.                */
    BSP_IntHandlerDMA2D                                         /* 106, INTISR[ 90]  DMA2D Interrupt.                     */
